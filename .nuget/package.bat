...
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-2.0\bin\Release\x86\*.dll lib\net20\x86
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-2.0\bin\Release\x64\*.dll lib\net20\x64
copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.5.2\bin\Release\MaxFactry.Provider.SQLite*.dll lib\net452\
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.5.2\bin\Release\x86\*.dll lib\net452\x86
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.5.2\bin\Release\x64\*.dll lib\net452\x64
copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.7.2\bin\Release\MaxFactry.Provider.SQLite*.dll lib\net472\
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.7.2\bin\Release\x86\*.dll lib\net472\x86
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.7.2\bin\Release\x64\*.dll lib\net472\x64
copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.8\bin\Release\MaxFactry.Provider.SQLite*.dll lib\net48\
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.8\bin\Release\x86\*.dll lib\net48\x86
rem copy ..\MaxFactry.Provider.SQLiteProvider-NF-4.8\bin\Release\x64\*.dll lib\net48\x64
